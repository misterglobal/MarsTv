...
<head>
  ...
  <?php if ($page === 'transfer'): ?><link rel="stylesheet" href="/assets/transfer.css"><?php endif; ?>
...
<body data-page="<?= e($page) ?>" data-api-base="<?= e($apiBase) ?>">
  ...
  <header class="site-header">
    ...
    <nav id="main-nav" aria-label="Main navigation">
      ...
      <a href="/transfer"<?= $page === 'transfer' ? ' aria-current="page"' : '' ?>>Transfer Pro</a>
...
<?php elseif ($page === 'activate'): ?>
    ...
    <section class="activation-shell shell" id="activation-app" aria-live="polite">
      ...
      <aside class="activation-help"><h3>Where is my code?</h3><p>Open MarsTV on your device, then go to <strong>Settings → Upgrade to Pro</strong>. The code and QR link appear together.</p><hr><h3>Already purchased?</h3><p>Your licence covers one installation. Visit the <a href="/transfer">transfer portal</a> to move Pro to a replacement or reinstalled device. Transfers are limited to one per rolling 30 days and three per rolling 365 days.</p><a href="/support">Get activation help →</a></aside>
    </section>
...
<?php elseif ($page === 'transfer'): ?>
    <?php require __DIR__.'/transfer.php'; ?>
...
<?php endif; ?>
  ...
  <?php if ($page === 'transfer'): ?><script src="/assets/transfer.js?v=20260910-1" defer></script><?php endif; ?>
</body>
</html>
