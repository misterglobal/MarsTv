...
private fun Channel.toEntity(generation: String) = CatalogItemEntity(
    ...
    artworkUrl = logoUrl,
    backdropUrl = "",
    playbackUrl = CatalogUrlCipher.seal(playbackUrl),
    description = "",
    rating = "",
    year = "",
    seriesId = "",
    ...
    catchUpTemplate = CatalogUrlCipher.seal(catchUpTemplate),
)
...
private fun CatalogItemEntity.toChannel() = Channel(
    ...
    logoUrl = artworkUrl,
    epgId = epgId,
    playbackUrl = CatalogUrlCipher.open(playbackUrl),
    supportsCatchUp = supportsCatchUp,
    catchUpDays = catchUpDays,
    catchUpTemplate = CatalogUrlCipher.open(catchUpTemplate),
)
